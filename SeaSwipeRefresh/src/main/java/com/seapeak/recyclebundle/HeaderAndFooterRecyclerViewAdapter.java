...
public class HeaderAndFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int TYPE_FOOTER_VIEW = Integer.MIN_VALUE + 20000;

    /**
     * 显示阈值 超过该值的item加载更多就显示 加载更多状态视图
     */
    private int showFootOffset = 6;
     ...
     * @return
     */
    public List<View> getAllFooterView() {
    ...
    public void addEmptyView(View emptyView) {
        ...
        mHeaderViews.add(emptyView);
        this.notifyDataSetChanged();
    }

    public void removeEmptyView() {
        if (emptyView != null) {
            mHeaderViews.remove(emptyView);
            this.notifyDataSetChanged();
            emptyView = null;
        }
    }

    public int getShowFootOffset() {
        return showFootOffset;
    }

    //设置显示脚阈值
    public void setShowFootOffset(int showFootOffset) {
        this.showFootOffset = showFootOffset;
    }
